...
public class AndroidJavaObjectDefaultEncapsulationTemplate extends JavaObjectDefaultEncapsulationTemplate {
	...
	public String getTemplateFilePath() {
		return TemplatesFilePath.JavaTemplatesFilePath.JAVA_OBJECT_DEFAULT_TEMPLATE_FILEPATH;
	}
