...
public class AndroidClassTableModelTemplate extends AndroidCRUDTemplates {

	public AndroidClassTableModelTemplate() {
	...
	public String getTemplateFilePath() {
		...
		return TemplatesFilePath.AndroidTemplatesFilePaths.ANDROID_CLASS_TABLE_MODEL_TEMPLATE_FILE_PATH;
	}
}
