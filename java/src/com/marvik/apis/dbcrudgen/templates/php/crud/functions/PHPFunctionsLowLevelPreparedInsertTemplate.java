 ...
 *
 */
public class PHPFunctionsLowLevelPreparedInsertTemplate extends PHPCrudTemplates {

	public PHPFunctionsLowLevelPreparedInsertTemplate() {
	...
	public String getTemplateFilePath() {
		return TemplatesFilePath.PHPTemplatesFilePaths.PHP_FUNCTION_LOW_LEVEL_PREPARED_INSERT_TEMPLATE_FILE_PATH;
	}
}
