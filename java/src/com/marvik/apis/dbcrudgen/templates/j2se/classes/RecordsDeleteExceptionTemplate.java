 ...
 *
 */
public class RecordsDeleteExceptionTemplate  extends J2SECRUDTemplates {

	public RecordsDeleteExceptionTemplate() {
	...
	public String getTemplateFilePath() {
		return TemplatesFilePath.JavaTemplatesFilePath.RECORDS_DELETE_EXCEPTION_TEMPLATE_FILE_PATH;
	}
