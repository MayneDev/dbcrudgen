 ...
 *
 */
public class RecordsInsertExceptionTemplate extends J2SECRUDTemplates {

	public RecordsInsertExceptionTemplate() {
	...
	public String getTemplateFilePath() {
		return TemplatesFilePath.JavaTemplatesFilePath.RECORDS_INSERT_EXCEPTION_TEMPLATE_FILE_PATH;
	}
