...
import com.marvik.apis.dbcrudgen.templates.j2se.classes.RecordsInsertExceptionTemplate;
import com.marvik.apis.dbcrudgen.templates.tags.TemplateTags;

/**
*Created on Feb 10, 2016-12:17:12 AM by victor
*/
 ...
 *
 */
public class RecordsInsertExceptionTemplateParser extends J2SETemplatesParser {

	/**
	 * RecordsInsertExceptionTemplateParser
	 */
	public RecordsInsertExceptionTemplateParser() {
	 ...
	 * @return
	 */
	public String parseInsertExceptionTemplateParser(J2SEProjectConfiguration j2seProjectConfiguration,
			Database database, String mysqlAPIStorageLocation) {
		String template = new RecordsInsertExceptionTemplate().getTemplate();
