...
public class Main {
	...
	private static void addTableOldAgeSickness(List<Table> tablesList) {
		...
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_info", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_causes", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_signs", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_treatment", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_treatment_precautions", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_prevention", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_caution", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("sickness_note", new DataType("text", new Constraints("text "))));
	...
	private static void addTableFamilyProblems(List<Table> tablesList) {
		...
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("family_planning_method", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("family_planning_method_information", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("method_precautions", new DataType("text", new Constraints("text "))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_family_planning_method",new DataType("integer", new Constraints("primary key auto_increment")));
	...
	private static void addTableGenitalProblems(List<Table> tablesList) {
		...
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("genital_problem", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("genital_problem_information", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("genital_problem_problems", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("genital_problem_signs", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("genital_problem_treatment", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("genital_problem_prevention", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("genital_problem_caution", new DataType("text", new Constraints("text "))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_genital_problem",new DataType("integer", new Constraints("primary key auto_increment")));
	...
	private static void addTableTeethGumsEyesProblems(List<Table> tablesList) {
		...
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("problem", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("problem_information", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("problem_treatment", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("problem_prevention", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("problem_caution", new DataType("text", new Constraints("text "))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_problem",new DataType("integer", new Constraints("primary key auto_increment")));
		tablesList.add(new Table("teeth_gums_eyes_problems", examiningSickPersonColumns, tableSql, primaryKey, null, null));
	}

	private static void addTableEyeProblems(List<Table> tablesList) {
		
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("eye_problem", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("eye_problem_info", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("eye_problem_signs", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("eye_problem_treatment", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("eye_problem_prevention", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("eye_problem_warning", new DataType("text", new Constraints("text "))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_eye_problem",new DataType("integer", new Constraints("primary key auto_increment")));
	...
	private static void addTableSkinProblems(List<Table> tablesList) {
		...
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("skin_problem", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("skin_problem_information", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("treatment", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("prevention", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("skin_problem_caution", new DataType("text", new Constraints("text "))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_skin_problem",new DataType("integer", new Constraints("primary key auto_increment")));
	...
	private static void addTableCommonSickness(List<Table> tablesList) {
		...
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_information", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_causes", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_signs", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_variants", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_prevention", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_treatment", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_medicine", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_caution", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("common_sickness_note", new DataType("text", new Constraints("text "))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_common_sickness",new DataType("integer", new Constraints("primary key auto_increment")));
	...
	private static void addTableVaccinations(List<Table> tablesList) {
		...
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("immunization", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("immunization_information", new DataType("text", new Constraints("text not null"))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_immunization",new DataType("integer", new Constraints("primary key auto_increment")));
	...
	private static void addTableWormsAndIntestinalParasites(List<Table> tablesList) {
		 ...
		 List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
			takingCareOfSickPersonColumnList.add(new TableColumn("worm_and_intestinal_parasite", new DataType("text", new Constraints("text not null"))));
			takingCareOfSickPersonColumnList.add(new TableColumn("worm_and_intestinal_parasite_information", new DataType("text", new Constraints("text "))));
			takingCareOfSickPersonColumnList.add(new TableColumn("infection_signs", new DataType("text", new Constraints("text "))));
			takingCareOfSickPersonColumnList.add(new TableColumn("transmission", new DataType("text", new Constraints("text "))));
			takingCareOfSickPersonColumnList.add(new TableColumn("health_effect", new DataType("text", new Constraints("text "))));
			takingCareOfSickPersonColumnList.add(new TableColumn("treatment_and_prevention", new DataType("text", new Constraints("text "))));
			takingCareOfSickPersonColumnList.add(new TableColumn("worm_and_intestinal_parasite_caution", new DataType("text", new Constraints("text "))));
		...
		+"infection_signs text, transmission text ,  health_effect text ,  treatment_and_prevention text , worm_and_intestinal_parasite_caution text  );";
			...
			PrimaryKey primaryKey = new PrimaryKey("id_worm_and_intestinal_parasite",new DataType("integer", new Constraints("primary key auto_increment")));
			tablesList.add(new Table("worms_and_intestinal_parasites", examiningSickPersonColumns, tableSql, primaryKey, null, null));
	}

	private static void addTableHealthProblemsSpecialDiet(List<Table> tablesList) {
		
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem_information", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem_signs", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem_signs_advanced", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem_treatment", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem_prevention", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem_caution", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("health_problem_note", new DataType("text", new Constraints("text "))));
		takingCareOfSickPersonColumnList.add(new TableColumn("special_diet", new DataType("text", new Constraints("text "))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_health_problem",new DataType("integer", new Constraints("primary key auto_increment")));
		tablesList.add(new Table("health_problems_special_diets", examiningSickPersonColumns, tableSql, primaryKey, null, null));
	}

	private static void addTableAntibioticsAndHowToUseThem(List<Table> tablesList) {
		
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(new TableColumn("item_title", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(new TableColumn("item_description", new DataType("text", new Constraints("text not null"))));
		...
		PrimaryKey primaryKey = new PrimaryKey("id_item",new DataType("integer", new Constraints("primary key auto_increment")));
		tablesList.add(new Table("antibiotics_and_how_to_use_them", examiningSickPersonColumns, tableSql, primaryKey, null, null));
	}
	...
	private static void addTableDangerousMedicine(List<Table> tablesList) {
		...
		takingCareOfSickPersonColumnList.add(
				new TableColumn("medicine", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(
				new TableColumn("misuse", new DataType("text", new Constraints("text not null"))));
		...
		String tableSql = "create table dangerous_medicine_misuse ("
			    +"id_medicine integer primary key auto_increment,"
			    +"medicine text not null,"
			    +"misuse text not null  )";

		PrimaryKey primaryKey = new PrimaryKey("id_medicine",new DataType("integer", new Constraints("primary key auto_increment")));
		tablesList.add(new Table("dangerous_medicine_misuse", examiningSickPersonColumns, tableSql, primaryKey, null, null));
	}
	...
	private static void addTableTakingCareOfTheSick(List<Table> tablesList) {
		...
		List<TableColumn> takingCareOfSickPersonColumnList = new ArrayList<TableColumn>();
		takingCareOfSickPersonColumnList.add(
				new TableColumn("care_item", new DataType("text", new Constraints("text not null"))));
		takingCareOfSickPersonColumnList.add(
				new TableColumn("sick_person_care", new DataType("text", new Constraints("text"))));
		takingCareOfSickPersonColumnList.add(
				new TableColumn("very_sick_person_care", new DataType("text", new Constraints("text"))));
		...
		String tableSql = "create table taking_care_of_sick("
			   +" id_care_item integer primary key auto_increment,"
			   +" care_item text not null,"
			   +" sick_person_care text,"
			   +" very_sick_person_care text)";

		PrimaryKey primaryKey = new PrimaryKey("id_care_item",new DataType("integer", new Constraints("primary key auto_increment")));
